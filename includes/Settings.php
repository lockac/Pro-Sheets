            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-actions">
                        ...
                        <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=prosheets&prosheets_duplicate=' . $id), 'prosheets_duplicate_' . $id)); ?>" class="icon-btn" title="Duplicate Table" onclick="return confirm('Duplicate this table?');">                        
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
                                    <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                                    <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                                    <line x1="15.8" y1="11.5" x2="15.8" y2="19.5"></line>
                                    <line x1="11.8" y1="15.5" x2="20" y2="15.5"></line>
