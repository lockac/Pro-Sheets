...
add_action('admin_notices', 'prosheets_duplicate_notice');
    ...
    if (isset($_POST['save_table_entry'])) {
        ...
        $posted = array(
            ...
            't_b_en' => isset($_POST['t_b_en']) ? 1 : 0, 't_b_hght' => sanitize_text_field($_POST['table_height']), 't_b_thk' => intval($_POST['t_b_thk']), 't_b_clr' => sanitize_hex_color($_POST['t_b_clr']), 't_b_rad' => intval($_POST['t_b_rad']), 't_b_shd' => sanitize_text_field($_POST['t_b_shd']), 't_b_pad_b' => sanitize_text_field($_POST['t_b_pad_b']),
